...
比赛数据集为已按照五个类别整理好的 APK 文件，总共 684 个（gamble涉赌 67| sex涉黄 145| scam涉诈 145| black黑灰产 140| normal正常 187）。**文件过于庞大，需要可联系作者**。

如果需要了解我们的模型训练数据集，比如提取了哪些特征、如何编码的、如何改进的，也可联系作者。如果我还没有忘记，有需要可以整理出来，如果时间久了忘记了就算了。毕竟我们的模型，在我现在看来，这似乎只是毫无科研训练的本科生调个包就说“这是一个模型”，并且特征工程也是毫无科研水平，属于本科生“闹着玩”似的。因此个人认为没有什么参考意义，就没有整理出来了。
