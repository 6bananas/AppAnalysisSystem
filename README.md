...
采用前后端分离架构，前端基于 [vue-element-admin](https://github.com/PanJiaChen/vue-element-admin) 二次开发，当前版本后端基于 Django 框架开发（比赛版本使用的是 Flask 框架）。
...
- SDK
  ...
  > [SDK 安装教程](https://blog.csdn.net/Yocczy/article/details/130916750)
  >
...
比赛数据集为已按照五个类别整理好的 APK 文件，总共 684 个（gamble涉赌 67| sex涉黄 145| scam涉诈 145| black黑灰产 140| normal正常 187）。**Issue 中的分享链接已失效！且可能由于安全因素有些文件不支持分享。如有需要，请联系 maas06533@gmail.com 。**
