...
回头再看，这个作品从系统设计、文档编写、PPT 制作、视频剪辑等各个方面来看，我觉得还是很一般。可能当初为了赶 ddl，而且自己一个人承担那么多任务并且最终还是搞出来了，当时就认为是一个很好的作品。不过无论如何，彼时亦或此时，我始终认为我做的部分（all 分析过程、all 后台开发、all 项目文档编写）都很不错，当然文档写得还是很欠水平，功底不够。
